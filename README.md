...
- **M3** — RNTuple read. _In progress: anchor (XXH3-verified), header/footer
  envelopes, and the schema (fields + columns) parse against a real ROOT
  fixture. Next: footer cluster groups → page list → page decode → values._
