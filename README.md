...
string branches) and write (scalar, fixed-size array, variable-length/jagged,
and string branches; ROOT/uproot-verified) · Zstd
...
**Not yet:** split / `std::vector` (`TBranchElement`) `TTree` branches, and
