...
pub mod prelude {
    ...
    pub use oxiroot_hist::{
        ...
        write_tprofile2d_file, write_tprofile3d_file, write_tprofile_file, GraphErrors, Hist,
        Merge, PolyBin, SparseBin, TAxis, TEfficiency, TGraph, TH2Poly, THnSparse, TProfile,
