...
pub mod prelude {
    ...
    pub use oxiroot_hist::{
        ...
        read_th1f, read_th2, read_th2d, read_th2f, read_th3, read_th3d, read_th3f, read_thnsparse,
        read_tprofile, read_tprofile2d, read_tprofile3d, write_histograms_dirs,
        ...
        write_tprofile_file, Hist, Merge, SparseBin, TAxis, TEfficiency, THnSparse, TProfile,
