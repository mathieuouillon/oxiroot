//! ROOT's parametric functions — [`TF1`], [`TF2`] and [`TF3`] — backed by the
//! [`oxiroot_formula`] expression engine.
//!
...
//!
//! Features:
//! - `fit`: `TF1::to_model`, which turns a function into an `oxiroot_fit::Model`.
